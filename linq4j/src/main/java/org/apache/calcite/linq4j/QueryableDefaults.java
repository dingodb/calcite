...
public abstract class QueryableDefaults {
   ...
   * {@link #groupBy(Queryable, FunctionExpression, FunctionExpression)},
   ...
   *
   * <p>NOTE: Renamed from {@code groupBy} to distinguish from
   * {@link #groupBy(Queryable, FunctionExpression, FunctionExpression, EqualityComparer)},
   * which has the same erasure.</p>
   */
   ...
   * {@link QueryProvider#createQuery createQuery}
   * method of the
   * {@link QueryProvider} represented by
   ...
   * {@link #select(Queryable, FunctionExpression)}.
   */
   ...
   * {@link #selectMany(Queryable, FunctionExpression)}.
   */
   ...
   *
   * <p>NOTE: Renamed from {@code selectMany} because had same erasure as
   * {@link #selectMany(Queryable, FunctionExpression, FunctionExpression)}.
   */
