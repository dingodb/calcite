...
interface ExtendedQueryable<TSource> extends ExtendedEnumerable<TSource> {
   ...
   * {@link #groupBy(FunctionExpression, FunctionExpression)},
   ...
   * {@link #select(FunctionExpression)}.</p>
   */
   ...
   * {@link #selectMany(FunctionExpression)}</p>
   */
   ...
   *
   * <p>NOTE: Renamed from {@code selectMany} because had same erasure as
   * {@link #selectMany(FunctionExpression, FunctionExpression)}
   */
