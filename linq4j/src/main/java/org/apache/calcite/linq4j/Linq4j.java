...
public abstract class Linq4j {
   ...
   * {@link Enumerator#close()}, so it is not safe to
   ...
   * (including {@link List} and {@link java.util.Set}) by supplying
   ...
   *
   * <p>Equivalent to {@link Objects#equals} in JDK 1.7 and above.
   */
   ...
   * returns argument.
   *
   * <p>Equivalent to {@link Objects#requireNonNull} in JDK 1.7 and
   * above.
   */
  @Deprecated // to be removed before 2.0
