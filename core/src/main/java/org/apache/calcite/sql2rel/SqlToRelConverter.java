...
public class SqlToRelConverter {
  ...
  public SqlToRelConverter(
    ...
    this.relBuilder = config.getRelBuilderFactory().create(cluster, validator != null ? validator.getCatalogReader().unwrap(RelOptSchema.class) : null)
    ...
    if (join.isNatural()) {
      ...
      switch (conditionType) {
        case NONE:
          ...
          break;
        case USING:
          condition = convertUsingCondition(join, getNamespace(left), getNamespace(right));
          rightRel = tempRightRel;
          break;
        case ON:
