...
public enum SqlTypeName {
  ...
  BIT(PrecScale.NO_NO | PrecScale.YES_NO, false, Types.BIGINT, SqlTypeFamily.NUMERIC),
  ...
  TIME(PrecScale.NO_NO | PrecScale.YES_NO | PrecScale.YES_YES, false, Types.TIME,
      SqlTypeFamily.TIME),
  TIME_WITH_LOCAL_TIME_ZONE(PrecScale.NO_NO | PrecScale.YES_NO, false, Types.OTHER,
      SqlTypeFamily.TIME),
  TIMESTAMP(PrecScale.NO_NO | PrecScale.YES_NO | PrecScale.YES_YES, false, Types.TIMESTAMP,
